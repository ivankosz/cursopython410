...
def super_promedio (lista):
    lista_copia = lista.copy()
    prom = promedio_alumnos(lista)
    for alumno in lista:
        if alumno[1] < prom:
            lista_copia.remove(alumno)
    for super in lista_copia:
        print(super)        
    return lista_copia

def sub_promedio (lista):
    lista_copia = lista.copy()
    prom = promedio_alumnos(lista)
    for alumno in lista:
        if alumno[1] >= prom:
            lista_copia.remove(alumno)
    for sub in lista_copia:
        print(sub)         
    return lista_copia
...
4) Eliminar alumno/a
5) Mostrar promedio
6) Mostrar alumnos por encima del promedio
7) Mostrar alumnos por debajo del promedio
8) Salir
"""
...
while opcion != 8:
    ...
    if opcion == 2:
        ...
        super_promedio (alumnos)
    elif opcion == 7:
        sub_promedio (alumnos)
